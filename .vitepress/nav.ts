        ...
        items: [
            {
                ...
                items: [
                    ...
                    { text: 'JavaScript', link: '/KnowledgeBase/FrontEnd/JavaScript' },
                    { text: 'TypeScript', link: '/KnowledgeBase/FrontEnd/TypeScript' },
            ...
            },
            {
                ...
                items: [
                    ...
                    { text: 'ReactNative', link: '/KnowledgeBase/Move/ReactNative' },
            ...
            },
            {
                ...
                items: [
                    ...
                    { text: 'MongoDB', link: '/KnowledgeBase/Database/MongoDB' },
                    { text: 'postgresql', link: '/KnowledgeBase/Database/ElasticSearch' }
                ]
            },
            {
                text: '数据结构与算法',
                items: [
                    { text: '数据结构', link: '/KnowledgeBase/Algorithm/DataStructure' },
                    { text: '算法', link: '/KnowledgeBase/Algorithm/Algorithm' }
                ]
            }
        ]
    },
        ...
        items: [
            {
                ...
                items: [
                    ...
                    { text: '@front-base/rnkits', link: '/Resource/vite-plugin' }
                ]
            },
            {
                text: '软件',
