...
export default defineConfig({
    ...
    head: [['link', { rel: 'icon', href: 'https://img.mtsws.cn/LightPicture/2023/08/8b794e021120837b.png' }]],
    srcDir: 'docs',
    themeConfig: {
        siteTitle: 'Mr焦',
