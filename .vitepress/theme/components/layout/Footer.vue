  ...
  <footer class="VPFooter">
    <div class="container">
        <p  class="recordCode">
            ...
            <span class="content">
            <a href="https://beian.miit.gov.cn" target="_blank">蜀ICP备17037090号-4</a>
            </span>
        </p>

        <p class="recordCode">
            <span class="icon">
            <img src="https://beian.mps.gov.cn/web/assets/logo01.6189a29f.png" title="联网备案号">
            </span>
            <span class="content">
            <a href="'https://beian.mps.gov.cn/#/query/webSearch" target="_blank">渝公网安备50010702505709号</a>
            </span>
        </p>
        <p  class="copyright">Copyright © 2024 我的编程日志 版权所有</p>
    </div>
  </footer>
</template>
