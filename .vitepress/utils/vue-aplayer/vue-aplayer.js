...
(function (e, t) {
    (function (a, s) {
        ...
        if (
            ...
            var a = function (o, h) {
                    return o.nodeName === "HTML"
                        ? -h
                        : o.getBoundingClientRect().top + h;
                },
                s = function (o) {
                    return o < 0.5
                        ? 4 * o * o * o
                ...
                d = function (o, h, m, u) {
                    ...
                    if (typeof o == "number") var E = parseInt(o);
                    else var E = a(o, L);
                    var H = Date.now(),
                        V =
                        ...
                        x = function () {
                            ...
                            u !== window
                                ? (u.scrollTop = l(L, E, $, h))
                                : window.scroll(0, l(L, E, $, h)),
                                $ > h ? typeof m == "function" && m(o) : V(x);
                        };
                    x();
                },
                r = function (o) {
...
var Y = z.exports;
const N = /* @__PURE__ */ j(Y),
    k = /mobile/i.test(window.navigator.userAgent),
    W = {
        isMobile: k,
        eventsName: {
         ...
         */
        secondToTime: (e) => {
            const t = (d) => (d < 10 ? "0" + d : "" + d),
                a = Math.floor(e / 3600),
                s = Math.floor((e - a * 3600) / 60),
                l = Math.floor(e - a * 3600 - s * 60);
...
`),
                ...
                for (let s = 0; s < t.length; s++) {
                    const l = t[s].match(/\[(\d{2}):(\d{2})(\.(\d{2,3}))?]/g),
                        d = t[s]
...
const yt = { render: ct },
    ...
    vt = ["onClick"],
    gt = { class: "aplayer-list-index" },
    wt = { class: "aplayer-list-title" },
    St = { class: "aplayer-list-author" };
    ...
    return (
        ...
        p(
            "div",
            {
                class: S([
                    "aplayer-list",
                    { "aplayer-list-hide": !a.aplayer.listFolded },
                ]),
            ...
            [
                i(
                    ...
                    {
                        style: g({
                            "max-height": `${a.aplayer.listMaxHeight}px`,
                        }),
                        ref: "ol",
                    },
                    [
...
const Lt = /* @__PURE__ */ M(ft, [["render", Tt]]),
    $t = {
        props: ["aplayer"],
        computed: {
            transformStyle() {
            ...
            i(
                ...
                [
                    ...
                    p(
                        ...
                        null,
                        I(
                            a.aplayer.lyrics[a.aplayer.index],
                            (r, o) => (
                                n(),
                                p(
                                    "p",
...
const bt = /* @__PURE__ */ M($t, [["render", Bt]]),
    R = ["one", "all", "none"],
    C = ["list", "random"],
    kt = {
        components: {
    ...
    Mt = { class: "aplayer-controller" },
    Et = {
        class: "aplayer-bar",
        ref: "aplayerBar",
    },
    Rt = { class: "aplayer-loading-icon" },
    Ct = { class: "aplayer-time-inner" },
    qt = { class: "aplayer-ptime" },
    xt = { class: "aplayer-dtime" },
    Nt = { class: "aplayer-volume-bar-wrap" },
    Ot = {
        ...
        p("div", Mt, [
            i(
                "div",
                {
                    ...
                    onMouseover:
                        t[0] || (t[0] = (u) => (l.aplayerThumbShowStatus = !0)),
                    onMouseout:
                        t[1] || (t[1] = (u) => (l.aplayerThumbShowStatus = !1)),
                },
                [
                    i(
                        "div",
                        ...
                        [
                            i(
                                "div",
                                {
                                    ...
                                    style: g({
                                        width: `${
                                            a.audioStatus.duration
                                                ? (a.audioStatus.loadedTime /
                                                      a.audioStatus.duration) *
                                                  100
                                                : 0
                                        }%`,
                            ...
                            i(
                                "div",
                                {
                                    ...
                                    style: g({
                                        width: `${
                                            a.audioStatus.duration
                                                ? (a.audioStatus.playedTime /
                                                      a.audioStatus.duration) *
                                                  100
                                                : 0
                                        }%`,
                                        background: `${
                                            a.aplayer.coverColor[
                                                a.aplayer.index
                                            ] ||
                                            ((o = d.audio) == null
                                                ? void 0
            ...
            i(
                "div",
                {
                    class: S({
                        "aplayer-time": !0,
                        "aplayer-time-narrow": a.styleStatus.timeNarrow,
                    }),
                },
                [
                    i("span", Ct, [
                        ...
                        [
                            i(
                                "button",
                                {
                                    ...
                                    onClick:
                                        t[5] || (t[5] = (u) => e.$emit("mute")),
                                },
                                [
                                    y(
                                        r,
                                        { type: d.switchVolumeIcon },
                                        null,
                                        8,
                                        ["type"]
                                    ),
...
const O = [
        ...
        methods: {
            ...
            setAudio(e) {
                ...
                (!t || t === "auto") &&
                    ...
                    t === "hls"
                        ...
                        : t === "normal" && (this.audioRef.src = e.url);
            },
            prevIndex() {
                    ...
                    try {
                        this.colorThief || (this.colorThief = new ColorThief()),
                            this.colorThief.getColorAsync(
                                (t = this.aplayer.audio[this.aplayer.index]) ==
                                    null
                                    ? void 0
                                    : t.cover,
                                ([a, s, l]) =>
            ...
            loadedTime() {
                return this.audioRef.buffered.length
                    ? this.audioRef.buffered.end(
                          this.audioRef.buffered.length - 1
                      )
                    : 0;
            },
            playedTime(e) {
            ...
            async loadLyric(e, t) {
                try {
                    ...
                    a.ok || a.status === 304
                        ? (e = c.parse(await a.text()))
                        : this.setNotice(
                              "LRC file request fails: status " + a.status
                          );
                } catch (a) {
                    console.warn(a);
                } finally {
            ...
            switchLyric(e) {
                ...
                this.aplayer.lyricType === 1
                    ? ((this.aplayer.lyrics[e] = [[0, "Loading"]]),
                      this.loadLyric(t, e))
                    : this.aplayer.lyricType === 2 &&
                      (this.aplayer.audio[e].lrc &&
                          (t = c.parse(this.aplayer.audio[e].lrc)),
            ...
            updateLyric() {
                ...
                if (e)
                    for (let t = 0; t < e.length; t++) {
                        const a = e[t],
                            s = e[t + 1];
                        this.audioStatus.playedTime >= a[0] &&
                            (!s || this.audioStatus.playedTime < s[0]) &&
            ...
            init() {
                (this.destroyComponent = !1),
                    (this.aplayer.storage =
                        JSON.parse(
                            localStorage.getItem(this.aplayer.storageName)
                        ) || {}),
                    (this.aplayer.volume =
                    ...
                    O.forEach((e) => {
                        this.audioRef.addEventListener(e, (t) =>
                            this.$emit(e, t)
                        );
                    }),
            ...
            setTheme(e, t = this.aplayer.index) {
                e &&
                    (this.aplayer.coverColor[t]
                        ...
                        : this.aplayer.audio[t] &&
                          (this.aplayer.audio[t].theme = e));
            },
            setMode(e = "normal") {
                (this.aplayer.mode = e), this.resize();
            },
            setLoop(e) {
                this.aplayer.audio.length <= 1 && e === "one" && (e = "all"),
                    (this.aplayer.loop = e);
            },
            setOrder(e) {
            ...
            setNotice(e, t = 2e3, a = 0.8) {
                if (
                    ...
                    this.aplayer.mode === "mini" ||
                    (this.aplayer.mode === "fixed" && this.styleStatus.mini)
                ) {
                    console.warn(e);
                    return;
                }
                (this.aplayer.noticeText = e),
                    (this.aplayer.noticeOpacity = a),
            ...
            showList() {
                this.$emit("listshow"),
                    this.aplayer.mode !== "mini" && this.$refs.list.showList(),
            ...
            addList(e, t = !1) {
                this.$emit("listadd", e),
                    ...
                    e.map(
                        (s) => (
                            (s.name = s.name || s.title || "Audio Name"),
                            (s.artist = s.artist || s.author || "Audio Artist"),
                            (s.cover = s.cover || s.pic),
                ...
                if (
                    ...
                    (this.aplayer.randomOrder = c.randomOrder(
                        this.aplayer.audio.length
                    )),
                    a)
                ) {
                    let s = 0;
                    this.aplayer.order === "random" &&
                        (s = this.aplayer.randomOrder[0]),
                        this.switchList(s);
                }
            },
            removeList(e) {
                this.$emit("listremove", nextIndex),
                    ...
                    this.aplayer.randomOrder.splice(
                        this.aplayer.randomOrder.indexOf(
                            this.aplayer.audio.length - 1
                        ),
                        1
                    ),
            ...
            switchList(e) {
                this.$emit("listswitch", e),
                    typeof e < "u" &&
                        ...
                        this.coverColor(),
                        this.aplayer.mode !== "mini" &&
                            N(e * 33, 500, null, this.$refs.list.ol),
                ...
                if (this.aplayer.audio.length > 1) {
                    ...
                    this.setNotice(
                        ...
                        this.skipForwardTimeout &&
                            clearTimeout(this.skipForwardTimeout),
            ...
            ended() {
                let e = this.aplayer.index;
                this.aplayer.loop === "none"
                    ? (this.skipForward(),
                      this.aplayer.order === "list"
                          ...
                          : this.aplayer.order === "random" &&
                            ...
                            this.aplayer.randomOrder.length - 1
                                ? this.play()
                                : this.pause()))
                    : this.aplayer.loop === "one"
                    ? (this.switchList(e), this.play())
                    : this.aplayer.loop === "all" &&
            ...
            resize() {
                this.aplayer.mode === "normal"
                    ? ((this.styleStatus.narrow =
                          this.$refs.aplayer.offsetWidth <= 300),
                      (this.styleStatus.timeNarrow =
                          this.$refs.info.offsetWidth <= 200))
        ...
        beforeUnmount() {
            this.clearList(),
                ...
                this.skipForwardTimeout &&
                    clearTimeout(this.skipForwardTimeout),
                O.forEach((e) => {
                    this.audioRef.removeEventListener(e, (t) =>
                        this.$emit(e, t)
                    );
                }),
    ...
    Ut = { class: "aplayer-music" },
    Pt = { class: "aplayer-title" },
    Dt = { class: "aplayer-author" },
    jt = { class: "aplayer-icon" },
    Yt = { ref: "audio" };
              ...
              "div",
              {
                  ...
                  class: S([
                      "aplayer",
                      {
                          ...
                          "aplayer-fixed": e.aplayer.mode === "fixed",
                          "aplayer-mini":
                              e.aplayer.mode === "mini" ||
                              (e.aplayer.mode === "fixed" &&
                                  e.styleStatus.mini),
                          "aplayer-loading":
                              e.audioStatus.playStatus &&
                              e.audioStatus.waitingStatus,
                          "aplayer-withlist": e.aplayer.audio.length > 1,
                          "aplayer-withlrc":
                              e.aplayer.mode === "normal" &&
                              e.aplayer.lyricShow,
